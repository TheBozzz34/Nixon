 ...
 */
package xyz.necrozma.discord.entities;
...
/**
 * A data-packet received from Discord via an {@link xyz.necrozma.discord.IPCClient IPCClient}.<br>
 * These can be handled via an implementation of {@link xyz.necrozma.discord.IPCListener IPCListener}.
 *
...
public class Packet
{
     ...
     * and the {@link xyz.necrozma.discord.IPCClient IPCClient}
     * connected.
     */
    public enum OpCode
    {
