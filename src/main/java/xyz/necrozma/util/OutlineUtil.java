...
public class OutlineUtil {
    ...
    public static final void renderOne(final float lineWidth) {
        checkSetupFBO();
    ...
    public static final void renderFour(final Color color) {
    ...
    public static final void setColor(final Color color) {
     ...
     */
    private static final void setupFBO(final Framebuffer fbo) {
